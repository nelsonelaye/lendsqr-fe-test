    ...
    <div>
      ...
      <div className={styles["page-header"]}>
        ...
        <div className={styles["active-btns"]}>
          <Button
            variant="blacklist"
            onClick={() =>
              toast.info("Blacklist feature coming soon", {
          ...
          <Button
            variant="activate"
            onClick={() =>
              toast.info("Activate feature coming soon", {
                description: "This action is not available yet.",
              })
            }
          >
      ...
      <Tabs.Root defaultValue="general">
          ...
          <div className={styles["highlight"]}>
            {isLoading ? (
              <>
                ...
                {/* Tier */}
                <div
                  className={`${styles["tier"]} ${styles["skeleton-block"]}`}
                >
        ...
        <Tabs.Content value="documents" className={styles["view-details"]}>
          <p style={{ padding: "30px" }}>No documents available.</p>
        </Tabs.Content>
        <Tabs.Content value="bank" className={styles["view-details"]}>
          <p style={{ padding: "30px" }}>No bank details available.</p>
        </Tabs.Content>
        <Tabs.Content value="loans" className={styles["view-details"]}>
          <p style={{ padding: "30px" }}>No loan records.</p>
        </Tabs.Content>
        <Tabs.Content value="savings" className={styles["view-details"]}>
          <p style={{ padding: "30px" }}>No savings records.</p>
        </Tabs.Content>
        <Tabs.Content value="app-system" className={styles["view-details"]}>
          <p style={{ padding: "30px" }}>No app/system data available.</p>
        </Tabs.Content>
      </Tabs.Root>
    </div>
  );
